...
@section('content')
    <style>
        /* Styles personnalisés pour la modification de catégorie */
        .gradient-bg {
            ...
            <div class="col-lg-8 col-xl-6">
                <div class="form-card">
                    ...
                    <div class="form-header">
                        ...
                        <p>Modifiez les informations de "{{ $category->name }}"</p>
                    </div>
                    ...
                    <div class="form-body">
                        <form action="{{ route('categories.update', $category) }}" method="POST"
                            ...
                            <div class="slug-preview" id="slugPreview"
                                style="display: {{ $category->slug ? 'block' : 'none' }};">
                                <i class="bi bi-link-45deg me-2"></i>
                                URL: <strong id="slugText">{{ $category->slug }}</strong>
                            </div>
                            ...
                            <div class="textarea-floating">
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    placeholder="Description de la catégorie" rows="4">{{ old('description', $category->description) }}</textarea>
                            ...
                            @if ($category->image)
                                <div class="current-image" id="currentImage">
                                    ...
                                    <!-- Champ caché pour marquer l'image à supprimer -->
                            ...
                            <div class="file-input-wrapper">
                                <label class="form-label fw-bold text-muted mb-2">
                                    <i class="bi bi-image me-2"></i>
                                    {{ $category->image ? 'Remplacer l\'image' : 'Image de la catégorie' }} (optionnelle)
                                </label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            nameInput.addEventListener('input', function() {
                ...
                if (name.trim()) {
                    ...
                    // Animation si le slug a changé
                    if (slug !== originalSlug) {
                        slugText.style.color = '#f5576c';
                        slugText.style.fontWeight = 'bold';
                    } else {
                        slugText.style.color = '#4a5568';
                        slugText.style.fontWeight = 'normal';
                    }
                } else {
            ...
            window.removeCurrentImage = function() {
                if (confirm('Êtes-vous sûr de vouloir supprimer l\'image actuelle ?')) {
                    ...
                    indicator.innerHTML =
                        '<div class="alert alert-warning mt-2"><i class="bi bi-exclamation-triangle me-2"></i>Image marquée pour suppression</div>';
                    currentImageDiv.appendChild(indicator);

                    // Masquer le bouton
                    currentImageDiv.querySelector('.remove-image-btn').style.display = 'none';
                }
            };

            // Gestion de l'upload d'image avec drag & drop (même code que create.blade.php)
            ...
            function previewImage(file) {
                ...
                reader.onload = function(e) {
                    ...
                    fileInputCustom.querySelector('.file-input-content').innerHTML = `
                        ...
                        <div>
                            <strong class="text-success">Nouvelle image sélectionnée</strong>
                            <div>${file.name}</div>
                        </div>
