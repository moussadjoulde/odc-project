...
function checkPasswordMatch() {
    ...
    if (confirmPassword.length > 0) {
        if (password === confirmPassword) {
            ...
            matchIndicator.innerHTML = '<small class="text-success"><i class="bi bi-check-circle me-1"></i>Les mots de passe correspondent</small>';
        } else {
            matchIndicator.style.display = 'block';
            matchIndicator.innerHTML = '<small class="text-danger"><i class="bi bi-x-circle me-1"></i>Les mots de passe ne correspondent pas</small>';
        }
    } else {
